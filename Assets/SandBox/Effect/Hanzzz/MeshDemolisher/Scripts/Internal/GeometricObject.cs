...
namespace Hanzzz.MeshDemolisher
{
    ...
    public class Point3D : IEquatable<Point3D>, IPointLocation
    {
        ...
        {
            return Math.Abs(this.x - other.x) <= Constant.EPSILON_D &&
                   Math.Abs(this.y - other.y) <= Constant.EPSILON_D &&
                   Math.Abs(this.z - other.z) <= Constant.EPSILON_D;
        }
    ...
    public class Point3DImplicit : IEquatable<Point3DImplicit>, IPointLocation
    {
        ...
        {
            return (p0.Equals(other.p0) && p1.Equals(other.p1) && t == other.t) ||
                   (p0.Equals(other.p1) && p1.Equals(other.p0) && t == 1d - other.t);
        }
    ...
    {
        // ===== TÊN DLL CHO DESKTOP (có native plugin) =====
#if (UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX) || (UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN)
        private const string dllName =
#if UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX
            "IndirectPredicates_Mac";
#else
            "IndirectPredicates_Windows";
#endif
#endif

        // ===== RÀNG BUỘC HÀM EXTERN/ STUB THEO PLATFORM =====
#if UNITY_WEBGL && !UNITY_EDITOR
        // WebGL KHÔNG hỗ trợ DLL native → tạo STUB để compile
        private static void Initialize() {}
        private static void Reset() {}
        private static void AddExplicitPoint(double[] p) {}
        private static void AddImplicitPoint(double[] p0, double[] p1, double t) {}
        private static int  Orient3D() { return 0; }
        private static int  InCircumsphere() { return 0; }
        private static bool LineCrossInnerTriangle() { return false; }
        private static bool LineCrossTriangle() { return false; }
        private static int  DotProductSign() { return 0; }
        private static bool SegmentCrossInnerSegment() { return false; }
        private static bool PointInInnerSegment() { return false; }
        private static bool InnerSegmentCrossInnerTriangle() { return false; }
        private static bool PointInInnerTriangle() { return false; }
        private static bool PointInTriangle() { return false; }

        /*
        // Nếu BẠN CÓ file .jslib cho WebGL, dùng khối dưới thay cho stub ở trên:
        private const string dllName = "__Internal";
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void Initialize();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void Reset();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void AddExplicitPoint(double[] p);
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void AddImplicitPoint(double[] p0, double[] p1, double t);
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern int  Orient3D();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern int  InCircumsphere();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern bool LineCrossInnerTriangle();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern bool LineCrossTriangle();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern int  DotProductSign();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern bool SegmentCrossInnerSegment();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern bool PointInInnerSegment();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern bool InnerSegmentCrossInnerTriangle();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern bool PointInInnerTriangle();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern bool PointInTriangle();
        */
#else
        // Các platform khác: dùng native DLL như cũ
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void Initialize();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void Reset();
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void AddExplicitPoint(double[] p);
        [System.Runtime.InteropServices.DllImport(dllName)] private static extern void AddImplicitPoint(double[] p0, double[] p1, double t);
